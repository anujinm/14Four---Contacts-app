<template lang="pug">
  .contacts
    .container
      contact(v-for="(contact, index) in contacts" :data="contact" :index="index"
        :infoState="infoState" :infoState2="infoState2" :hover="onMouseHover" :hoverOff="onMouseOut" :inactive="isInactive(index)" :active="isActive(index)")
</template>
